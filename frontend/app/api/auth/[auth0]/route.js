    ...
    if (auth0 === "callback") {
      ...
      if (error) {
        ...
        return NextResponse.redirect(
          `${process.env.AUTH0_BASE_URL}?error=${error}&description=${encodeURIComponent(errorDescription || "")}`,
        );
      }
      ...
      try {
        ...
        return NextResponse.redirect(
          `${process.env.AUTH0_BASE_URL}?error=callback_error&description=${encodeURIComponent(error.message)}`,
        );
      }
    }
    ...
    if (auth0 === "me") {
      ...
      try {
        ...
        console.log(
          ...
          sessionData.user.email || sessionData.user.sub,
        );
